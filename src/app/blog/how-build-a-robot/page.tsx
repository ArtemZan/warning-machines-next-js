...
const article = {
  ...
  canonicalUrl: 'https://warning-machines.com/how-build-a-robot/',
  datePublished: '2025-06-18',
  dateModified: '2025-06-18',
};

export const metadata: Metadata = buildArticleMetadata(article, 'how-build-a-robot');

export default function RobotDevelopmentPage() {
  const jsonLd = buildArticleJsonLd(article, 'how-build-a-robot');
