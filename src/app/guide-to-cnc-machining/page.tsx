...
const article = getArticleById('the-ultimate-guide-to-cnc-machining');

export const metadata = article ? buildArticleMetadata(article, 'the-ultimate-guide-to-cnc-machining') : {};
